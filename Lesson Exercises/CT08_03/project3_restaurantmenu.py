...
def ask_for_food():
    ...
    while True:
        ...
        if question[0:6] == "remove":
            if question[7:] not in order:
                print("You do not have that in your order")
            else:
                del order[question[7:]]
                print(f"Your {question[7:]} has been removed")
                wallet += menu[question[7:]]
                print(f"Your balance is now ${wallet:.2f}")
        elif question in menu:
